...
javascript.javascriptGenerator.forBlock['object_model'] = function (block) {
  ...
  var relationshipTypes = Blockly.JavaScript.statementToCode(
    block,
    'RELATIONSHIP_TYPES'
  );
  var typeDefinitions = Blockly.JavaScript.statementToCode(
    block,
    'TYPE_DEFINITIONS'
  );
...
javascript.javascriptGenerator.forBlock['object_type'] = function (block) {
  ...
  var characteristics = Blockly.JavaScript.statementToCode(
    block,
    'CHARACTERISTICS'
  );
...
javascript.javascriptGenerator.forBlock['animate_extension'] = function (
  block
) {
  return '';
};
...
javascript.javascriptGenerator.forBlock['characteristic_def'] = function (
  block
) {
...
javascript.javascriptGenerator.forBlock['attribute_def'] = function (block) {
  ...
  var attrType = Blockly.JavaScript.valueToCode(
    block,
    'ATTR_TYPE',
...
javascript.javascriptGenerator.forBlock['relationship_type'] = function (
  block
) {
...
javascript.javascriptGenerator.forBlock['type_definition'] = function (block) {
  ...
  var dataType = Blockly.JavaScript.valueToCode(
    block,
    'DATA_TYPE',
    Blockly.JavaScript.ORDER_ATOMIC
  );
...
javascript.javascriptGenerator.forBlock['type_definition_ref'] = function (
  block
) {
...
javascript.javascriptGenerator.forBlock['parameter'] = function (block) {
  ...
  var paramType = Blockly.JavaScript.valueToCode(
    block,
    'PARAM_TYPE',
    Blockly.JavaScript.ORDER_ATOMIC
  );
  ...
  var code =
    'Parameter ' + paramArticle + ' ' + paramName + ' : ' + paramType + '\n';
...
javascript.javascriptGenerator.forBlock['data_type'] = function (block) {
  ...
  var numberSpec = Blockly.JavaScript.valueToCode(
    block,
    'NUMBER_SPEC',
    Blockly.JavaScript.ORDER_ATOMIC
  );
...
javascript.javascriptGenerator.forBlock['number_specification'] = function (
  block
) {
